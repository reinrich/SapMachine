...
class ScopeDesc : public ResourceObj {
 public:
  ...
  bool not_global_escape_in_scope() const { return _not_global_escape_in_scope; }
 ...
 private:
  ...
  bool          _return_oop;
  bool          _not_global_escape_in_scope;  // NoEscape or ArgEscape in any of the scopes at compiled pc

...
//    static {
//        try {
//            System.loadLibrary("GetOwnedMonitorStackDepthInfoWithEATest");
//        } catch (UnsatisfiedLinkError ule) {
//            System.err.println("Could not load GetOwnedMonitorStackDepthInfoWithEATest library");
...
//    }
    ...
    public static native int getOwnedMonitorsFor(Thread t1, Object[] ownedMonitors, int[] depths);
    ...
    public static class TestCase_1 extends TestCaseBase {
        ...
        public void runTest() throws Exception {
            ...
            int monitorCount = getOwnedMonitorsFor(t1, ownedMonitors, depths);

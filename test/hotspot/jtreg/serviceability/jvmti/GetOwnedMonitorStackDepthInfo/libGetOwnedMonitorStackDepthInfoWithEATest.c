...
JNIEXPORT jint JNICALL
Java_GetOwnedMonitorStackDepthInfoWithEATest_getOwnedMonitorsFor(JNIEnv *env, jclass cls, jobject targetThread, jobjectArray ownedMonitors, jintArray depths) {
    jvmtiError err;

 ...
 *          Therefore escape analysis should be disabled when an agent acquires the associated capability can_tag_objects.
 * @requires ((vm.compMode != "Xcomp") & vm.compiler2.enabled & (vm.opt.TieredCompilation != true))
 * @library /test/lib
